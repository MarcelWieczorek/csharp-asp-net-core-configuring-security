...
namespace ConferenceTracker
{
    public class Startup
    {
        ...
        {
            this.SecretMessage = Configuration["SecretMessage"];
            ...
            services.AddCors(options => { options.AddPolicy(_allowedOrigins, builder => { builder.WithOrigins("https://pluralisght.com"); }); }) ;
        }
